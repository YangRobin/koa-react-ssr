...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES ('00000000086', '机器学习理论', 'computer', '文章', 'mLearn', null, '1', '<h3>监督学习和非监督学习</h3><pre class=\"ql-syntax\" spellcheck=\"false\">var name =\"robin\"\nsetTimeout(()=&gt;{console.log(\"roiin\")},1000);\n</pre><p> 如何提高自己的学习能力呢？</p><ol><li>首先需要克制自己的贪婪的欲望.</li><li>定一个小目标.</li><li>然后努力，坚持.</li></ol>', '2019-03-10T09:25:39.802Z', '/img/微信图片_20190310172107.png', 'undefined', null, '0');
INSERT INTO `article` VALUES ('00000000087', '机器学习理论', 'computer', '文章', 'mLearn', null, '1', '<h3>监督学习和非监督学习</h3><pre class=\"ql-syntax\" spellcheck=\"false\">``` javascriptvar \n  name =\"robin\"\n  setTimeout(()=&gt;{console.log(\"roiin\")},1000);\n   \n```\n</pre><p> 如何提高自己的学习能力呢？</p><ol><li>首先需要克制自己的贪婪的欲望.</li><li>定一个小目标.</li><li>然后努力，坚持.</li></ol>', '2019-03-10T09:27:47.602Z', '/img/微信图片_20190310172107.png', 'undefined', null, '0');
INSERT INTO `article` VALUES ('00000000114', 'light_test', 'computer', '文章', 'webFront', null, '1', '<pre class=\"ql-syntax\" spellcheck=\"false\"><span class=\"hljs-function\"><span class=\"hljs-title\">if</span><span class=\"hljs-params\">(true)</span></span>{ console.log() }\n</pre>', '2019-03-10T12:36:28.052Z', '', 'undefined', null, '0');
